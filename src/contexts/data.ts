...
const initialData: DataType = {
  hero: {
    ...
    subtitle: `{"root":{"children":[{"children":[{"detail":0,"format":0,"mode":"normal","style":"","text":"Nothing’s better than a 1:1 chat. Lets connect and build some epic products together :)","type":"text","version":1}],"direction":"ltr","format":"","indent":0,"type":"paragraph","version":1}],"direction":"ltr","format":"","indent":0,"type":"root","version":1}}`,
  },
  about: {
